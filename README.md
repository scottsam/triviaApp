...
This Trivia project allows users to test their knowledge generally by answering questions from different categories. It also has quiz questions that can be played with friends or self. The project task was to create and API and unit test for implementing the application allowing it to do the following:

1. Display questions - both all questions and by category. Questions should show the question, category and difficulty rating by default and can show/hide the answer.
2. Delete questions.
3. Add questions and require that they include question and answer text.
4. Search for questions based on a text query string.
5. Play the quiz game, randomly selecting questions from a category
...
#### GET '/categories'
- Returns an object with a with a property "categories" whose value is a dictionary key:value pair id : strings
...
- Gets all questions in a specified category id using url parameters
- Returns a JSON object with paginated questions
...
## NB: using curls on windows requires you to use double quotes and also escape with back slashes("\")
- Created question:
```
{
    "answer": "1085m", 
